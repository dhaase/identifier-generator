...
public class Crc32c implements Checksum {
    ...
    public static final int hash32(int data) {
        return (int) end(crc32c(~0, data));
    }

    public static final int hash64(long data) {
        int hash = crc32c(~0, (int) data);
        return (int) end(crc32c(hash, (int) (data >>> 32)));
    }
    ...
    private static long end(int crc) {
